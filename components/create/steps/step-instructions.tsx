...
export function StepInstructions() {
  ...
  const handleAutoInstructions = async () => {
    ...
    try {
      ...
      toast('Instructions generated by Claude!', 'success')
    } catch (err) {
    ...
    <div className="p-8 max-w-4xl mx-auto">
      <div className="mb-6">
        ...
        <p className="text-sm text-secondary">
          ...
          Or let Claude figure it out automatically.
        </p>
      </div>
      ...
      <div className="grid grid-cols-5 gap-6">
        ...
        <div className="col-span-2 space-y-4">
          ...
          <div className="bg-surface-2 border border-border rounded-xl p-4">
            ...
            {profile && config.useFaceProfile && (
              <div className="mt-3 flex items-center gap-2 pt-3 border-t border-border">
                ...
                />
                <div>
                  <p className="text-xs text-primary">Using PuLID-FLUX</p>
                  <p className="text-[10px] text-muted">Identity preservation model</p>
                </div>
          ...
          <div className="bg-surface-2 border border-border rounded-xl p-4">
            ...
            <p className="text-xs text-muted leading-relaxed">
              Claude analyzes your reference + assets + instructions and builds a detailed generation prompt.
              Then FLUX generates 2 variants for you to choose from.
            </p>
          </div>
        </div>
      </div>
